<div class="modal fade" id="modal-sub-kriteria" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="modal-kriteriaLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-fullscreen">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modal-title-sub">Tambah Sub Kriteria untuk &nbsp;<span id="judul-kriteria"></span></h5>
                <button type="button" class="btn-close-sub" id="btn-close" data-bs-dismiss="modal" aria-label="Close">x</button>
