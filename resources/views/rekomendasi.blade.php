...
<body>
    <div id="spinner"></div>
    <a href="https://github.com/alexandracaulea/freecodecamp-projects/tree/master/Responsive-Web-Design-Projects/Build%20a%20Survey%20Form"
        target="_blank" rel="noopener noreferrer" class="github-corner" aria-label="View source on GitHub">
                    ...
                    @foreach ($kriterias as $key => $kriteria)
                        ...
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="c{{ $kriteria->kode }}"
    ...
    <!-- Modal -->
    <div class="modal fade" id="modal-rekomendasi" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
